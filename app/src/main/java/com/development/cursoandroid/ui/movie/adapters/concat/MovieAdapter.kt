...
import com.development.cursoandroid.core.BaseViewHolder
import com.development.cursoandroid.data.model.Movie
import com.development.cursoandroid.databinding.MovieItemBinding
...
class MovieAdapter(
    ...
    private inner class MoviesViewHolder(
        ...
        override fun bind(item: Movie) {
            Glide.with(context).load(item.posterPath.getImageUrl()).centerCrop()
