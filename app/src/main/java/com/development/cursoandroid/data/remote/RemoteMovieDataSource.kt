...
class RemoteMovieDataSource(private val webService: WebService) {
    suspend fun getUpcomingMovies(): MovieList = webService.getUpcomingMovies(ApiConstants.API_KEY, ApiConstants.LANGUAGE)

    suspend fun getTopRatedMovies(): MovieList = webService.getTopRatedMovies(ApiConstants.API_KEY, ApiConstants.LANGUAGE)
